...
% Proportionally place the axes
for ii=1:numel(NewSubplotAxes)
    curSubplotPos = NewSubplotAxes(ii).Position;
%     newSubAxes=axes('Position',[SubplotPos(1)+SubplotPos(3)*curSubplotPos(1) SubplotPos(2)+SubplotPos(4)*curSubplotPos(2) SubplotPos(3)*curSubplotPos(3) SubplotPos(4)*curSubplotPos(4)]);
%     copyobj(allchild(NewSubplotAxes(ii)),newSubAxes)     % Set position to orginal subplot axes
    set(NewSubplotAxes(ii),'Position',[SubplotPos(1)+SubplotPos(3)*curSubplotPos(1) SubplotPos(2)+SubplotPos(4)*curSubplotPos(2) SubplotPos(3)*curSubplotPos(3) SubplotPos(4)*curSubplotPos(4)])     % Set position to orginal subplot axes
end
