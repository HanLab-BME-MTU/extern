function [xe,ye]=mpt_plotellip(A,b,c,linetype,plotYes)
...
if nargin==2
  type1=1;  xc=b;  linetype='-';   plotYes = false;
elseif nargin==3 & ischar(c)
  type1=1;  xc=b;  linetype=c;   plotYes = false;
elseif nargin==3
  type1=0;  linetype='-';   plotYes = false;
else
  type1=0;
end
...
if plotYes%Marco Vilela, 07/2012
