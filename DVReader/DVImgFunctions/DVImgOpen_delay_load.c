 ...
 */
FARPROC WINAPI DVImgOpenDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = DVImgOpenDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = DVImgOpenDelayLoadWin32FailureHook;
#endif
