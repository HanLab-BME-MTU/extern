...
fileInfo{1}{1} = 'T*.mat'; %filename
fileInfo{1}{2} = 1; %Channel number

% Bead Parameter
%Pixel Intensity Threshold (lower value lets in more pixels)
beadParam{1}.thres = 0.5;
%Minimum bead size
beadParam{1}.minSize = 0;
%Maximum bead size
beadParam{1}.maxSize = Inf;
%Window size - should be set to be just bigger than the particle size
...
% TPT Parameter
    ...
    tptParam{1}.knnFM = 14;
    %Retained Neighbors
    tptParam{1}.fmThres = 10;
    %Universal Median Test
    tptParam{1}.outlrThres = 5;
    
    %These Don't Have A Large Effect
    %Particle Descriptor Neighbors
    tptParam{1}.knnFD = 16;
    %Concentric Spheres used
