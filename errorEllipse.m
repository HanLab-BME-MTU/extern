...
%        Set conf=-1 to plot the square root of the variance in the
...
if conf == -1
    % don't get conficende interval, just plot sigma
    k = 1;
else
