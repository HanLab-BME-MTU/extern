...
%NETLAB_KMEANS	Trains a k means cluster model.
%
%	Description
%	 CENTRES = NETLAB_KMEANS(CENTRES, DATA, OPTIONS) uses the batch K-means
...
%
%	[CENTRES, OPTIONS, POST, ERRLOG] = NETLAB_KMEANS(CENTRES, DATA, OPTIONS)
